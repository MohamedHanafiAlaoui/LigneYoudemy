...
// $Teacher =User::
$Teachers = User::userEtudiant(); // Récupération des enseignants
  ...
  <div class="main-content">
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
      <div class="container-fluid">
        <h3 class="navbar-brand">bane Etudiant</h3>
      ...
      <div class="row mb-4">
        <div class="col-md-12">
          <div class="card p-4 shadow-sm">
            <h5 class="mb-3">Etudiant List</h5>
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  <span class="badge bg-success"><?php echo $Teacher->getbane(); ?></span>
                  </td>
                  <td>
                    <a href="../../src/modle/edit-Etudiant.php/?id=<?php echo $Teacher->getid(); ?>&status=<?php echo $Teacher->getbane(); ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                  </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
